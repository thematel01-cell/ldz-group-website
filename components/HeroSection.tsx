      ...
      <div className="container-shell relative grid gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
        <div>
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <Link href={homeHero.primaryCta.href} className="btn-light">
              {t(homeHero.primaryCta.label, locale)}
            </Link>
            <Link href={homeHero.secondaryCta.href} className="btn-light">
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            {homeHero.stats.map((stat, index) => (
              ...
              >
                <div className="text-3xl font-semibold text-[var(--primary-dark)]">{stat.value}</div>
